...
const contentEngine = engineOptions => {
  ...
  const createSubProcessIfNoneExists = async ({
    ...
    if (!internalState.subProcess) {
      ...
      const contentEngineDir = (0, _createRequireFromPath.resolveFromContentEngine)(`/services/content-engine`, (_engineOptions3 = engineOptions) === null || _engineOptions3 === void 0 ? void 0 : _engineOptions3.directory);
      const reduxDir = (0, _createRequireFromPath.resolveFromContentEngine)(`/redux`, (_engineOptions4 = engineOptions) === null || _engineOptions4 === void 0 ? void 0 : _engineOptions4.directory);
  ...
  const deleteCache = async () => {
    await stop();
    const cachePath = _path.default.join(
    // this is guarunteed to exist because it's set to process.cwd() if it's not passed in
    engineOptions.directory, `.cache`);
