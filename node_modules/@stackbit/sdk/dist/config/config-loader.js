...
function mergeConfigModelsWithExternalModels({ configModels, externalModels, logger }) {
    ...
    for (const configModel of configModels) {
        ...
        if (!externalModel) {
            logger === null || logger === void 0 ? void 0 : logger.warn(`Can't remap model '${configModel.name}', the model doesn't exist in content source`);
            continue;
        }
        ...
        mergedModel = (0, utils_2.mapModelFieldsRecursively)(mergedModel, (externalField, modelKeyPath) => {
            ...
            if (externalField.type === 'list') {
                if (!stackbitField.type || stackbitField.type === 'list') {
                    stackbitFieldProps = 'items' in stackbitField ? (_a = stackbitField.items) !== null && _a !== void 0 ? _a : {} : {};
                }
                else {
                    stackbitFieldProps = {};
                    logger === null || logger === void 0 ? void 0 : logger.warn(`Can't remap field of model '${mergedModel.name}' ` +
            ...
            externalField = (0, utils_2.mapListItemsPropsOrSelfSpecificProps)(externalField, (externalFieldProps) => {
                ...
                if (stackbitFieldProps.type && stackbitFieldProps.type !== externalFieldProps.type) {
                    if (allowedOverrideTypes && allowedOverrideTypes.includes(stackbitFieldProps.type)) {
                        ...
                        logger === null || logger === void 0 ? void 0 : logger.warn(`Can't remap field of model '${mergedModel.name}' at path '${(0, utils_1.fieldPathToString)(modelKeyPath)}' ` +
...
function normalizeConfig(rawConfig) {
    ...
    return {
        ...
        contentEngine: (rawConfig === null || rawConfig === void 0 ? void 0 : rawConfig.contentEngine) || { port: CONTENT_ENGINE_DEFAULT_PORT, host: 'localhost' },
...
function getReferencedModelNames(field) {
    ...
    if ((0, utils_2.isModelField)(fieldSpecificProps) && ((_a = fieldSpecificProps.models) === null || _a === void 0 ? void 0 : _a.length) > 1) {
        const modelNames = fieldSpecificProps.models;
        referencedModelNames = lodash_1.default.union(referencedModelNames, modelNames);
    }
    else if ((0, utils_2.isReferenceField)(fieldSpecificProps) && ((_b = fieldSpecificProps.models) === null || _b === void 0 ? void 0 : _b.length) > 0) {
        const modelNames = fieldSpecificProps.models;
        referencedModelNames = lodash_1.default.union(referencedModelNames, modelNames);
    }
...
function getInternalStackbitRunnerOptions(config) {
    var _a, _b, _c;
    const experimentalSsgData = ((_a = config === null || config === void 0 ? void 0 : config.experimental) === null || _a === void 0 ? void 0 : _a.ssg) || config.__unsafe_internal_stackbitRunnerOptions;
    if (!experimentalSsgData) {
        return;
    }
    let doneStart = (_b = experimentalSsgData.logPatterns) === null || _b === void 0 ? void 0 : _b.up;
    if (typeof doneStart === 'string') {
        doneStart = [doneStart];
    }
    else if (Array.isArray(doneStart) && doneStart.length === 0) {
        doneStart = undefined;
    }
    const ssgRunOptions = (0, utils_1.omitByNil)({
        displayName: experimentalSsgData.name,
        triggerInstallFiles: (_c = experimentalSsgData.watch) === null || _c === void 0 ? void 0 : _c.reinstallPackages,
