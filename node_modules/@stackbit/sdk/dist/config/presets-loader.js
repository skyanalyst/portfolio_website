...
async function loadPresets({ config, fallbackSrcType, fallbackSrcProjectId }) {
    ...
    for (const presetFile of presetFiles) {
        ...
        const srcType = (_a = presetData.srcType) !== null && _a !== void 0 ? _a : fallbackSrcType;
        const srcProjectId = (_b = presetData.srcProjectId) !== null && _b !== void 0 ? _b : fallbackSrcProjectId;
...
function extendModelsWithPresetsIds({ models, presets }) {
    ...
    return models.map((model) => {
        ...
        if ('srcType' in model && 'srcProjectId' in model) {
            ...
            presetIdsForModel = (_b = (_a = presetsIdsByContentSourceAndModel[srcType]) === null || _a === void 0 ? void 0 : _a[srcProjectId]) === null || _b === void 0 ? void 0 : _b[model.name];
        }
        else {
