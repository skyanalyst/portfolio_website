...
export interface Config extends Omit<StackbitConfig, 'models' | 'customContentReload' | 'experimental' | 'sitemap'> {
    dirPath: string;
    filePath: string;
    models: Model[];
    presets?: PresetMap;
...
/*********************************
 *** Internal Field Properties ***
 *********************************/

declare module '@stackbit/types' {
    interface FieldCustomControlTypeProps {
        controlUrl?: string;
    }
}
