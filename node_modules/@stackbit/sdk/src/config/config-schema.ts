...
const fieldCommonPropsSchema = Joi.object({
    ...
    actions: Joi.array().items(customActionBaseSchema),
...
const localizedModelSchema = Joi.object<ModelLocalized>({
    localized: Joi.boolean(),
    locale: Joi.function()
});
...
const configModelSchema: Joi.ObjectSchema<ConfigModel> = baseModelSchema
    .concat(
        Joi.object({
