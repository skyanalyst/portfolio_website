...
export declare function createPlainApiClient({ accessToken, spaceId, environment }: PlainApiClientOptions): PlainClientAPI;
...
export declare function createScheduledAction(client: PlainClientAPI, options: {
    ...
    schedule: import("@stackbit/types").ScheduledAction;
...
export declare function updateScheduledAction(client: PlainClientAPI, scheduledActionId: string, options: {
    ...
    executeAt?: string;
    environment: string;
}): Promise<import("@stackbit/types").ScheduledAction>;
...
export declare function getScheduledAction(client: PlainClientAPI, scheduledActionId: string, options: {
    environment: string;
}): Promise<import("@stackbit/types").ScheduledAction | null>;
export declare function fetchAllItems<T>(getMany: (params: QueryParams) => Promise<CollectionProp<T>>, logger?: Logger): Promise<T[]>;
