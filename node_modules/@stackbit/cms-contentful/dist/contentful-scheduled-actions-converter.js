...
function findScheduleForRelease(contentfulSchedulesForEntity) {
    if (!(contentfulSchedulesForEntity === null || contentfulSchedulesForEntity === void 0 ? void 0 : contentfulSchedulesForEntity.length)) {
        return null;
    }
...
function convertAndFilterScheduledActions(contentfulReleases, contentfulSchedules) {
    ...
    for (const contentfulRelease of contentfulReleases) {
        const releaseSchedule = findScheduleForRelease((_a = schedulesByEntity[contentfulRelease.sys.id]) !== null && _a !== void 0 ? _a : []);
        if (releaseSchedule) {
