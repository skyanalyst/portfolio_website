...
exports.fetchAllItemsCursor = exports.fetchAllItems = exports.getScheduledAction = exports.cancelScheduledAction = exports.updateScheduledAction = exports.createScheduledAction = exports.fetchScheduleById = exports.fetchAllSchedules = exports.fetchAllReleases = exports.fetchAllWebhooks = exports.fetchAllAppInstallations = exports.fetchAllEditorInterfaces = exports.fetchAllContentTypes = exports.fetchAllUsers = exports.fetchAllLocales = exports.fetchAllAssets = exports.fetchAllEntries = exports.fetchAssetsByIds = exports.fetchEntriesByIds = exports.getBulkAction = exports.createWebhook = exports.createPublishBulkAction = exports.createValidateBulkAction = exports.publishAsset = exports.processAssetForAllLocales = exports.createAssetFromFile = exports.createAsset = exports.deleteEntry = exports.unpublishEntry = exports.publishEntry = exports.updateEntry = exports.createEntry = exports.fetchAssetById = exports.fetchEntryById = exports.createPlainApiClient = void 0;
...
function createPlainApiClient({ accessToken, spaceId, environment }) {
    return (0, contentful_management_1.createClient)({ accessToken: accessToken }, {
        type: 'plain',
        defaults: {
            spaceId: spaceId,
...
async function fetchAllItems(getMany, logger) {
    var _a;
    let limit = 1000;
    let items = [];
    ...
    while (hasMoreItems) {
        try {
            ...
            if (result.total > 1000) {
                logger === null || logger === void 0 ? void 0 : logger.info(`Fetched ${items.length} of ${result.total} items`);
            }
        }
        catch (err) {
            if (retries > 4) {
            ...
            if ((_a = lodash_1.default.get(err, 'message')) === null || _a === void 0 ? void 0 : _a.includes('Response size too big')) {
...
async function fetchAllItemsCursor(fn, query, logger) {
    ...
    while (hasMoreItems) {
        try {
            ...
            items = items.concat(result.items);
            hasMoreItems = !!((_a = result.pages) === null || _a === void 0 ? void 0 : _a.next);
            const nextUrlParams = (_c = (_b = result.pages) === null || _b === void 0 ? void 0 : _b.next) === null || _c === void 0 ? void 0 : _c.split('?')[1];
            pageNext = (_d = new URLSearchParams(nextUrlParams).get('pageNext')) !== null && _d !== void 0 ? _d : undefined;
            retries = 0;
            limit = 1000;
            logger === null || logger === void 0 ? void 0 : logger.info(`Fetched ${items.length} items`);
        }
        catch (err) {
            if (retries > 4) {
                throw err;
            }
            if ((_e = lodash_1.default.get(err, 'message')) === null || _e === void 0 ? void 0 : _e.includes('Response size too big')) {
                limit = Math.trunc(limit / 2);
            }
            else {
                throw err;
