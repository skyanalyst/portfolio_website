...
function mapModel(options) {
    ...
    return Object.assign({
        ...
        label: (_a = contentType.name) !== null && _a !== void 0 ? _a : lodash_1.default.startCase(contentTypeId),
        description: (_b = contentType.description) !== null && _b !== void 0 ? _b : null,
...
function mapFields({ contentType, editorInterfaceByContentTypeId, defaultLocaleCode, cloudinaryImagesAsList, bynderImagesAsList }) {
    ...
    const editorInterfaceControls = (_a = editorInterfaceByContentTypeId[contentTypeId]) === null || _a === void 0 ? void 0 : _a.controls;
...
function mapField({ field, editorInterfaceControlsByFieldId, defaultLocaleCode, cloudinaryImagesAsList, bynderImagesAsList }) {
    ...
    const isHidden = (_a = field.disabled) !== null && _a !== void 0 ? _a : isReadonly;
    ...
    return lodash_1.default.assign({
        ...
        label: (_b = field.name) !== null && _b !== void 0 ? _b : lodash_1.default.startCase(fieldId),
...
function getDefaultValue(field, defaultLocaleCode, editorInterfaceControl) {
    ...
    const widgetId = editorInterfaceControl === null || editorInterfaceControl === void 0 ? void 0 : editorInterfaceControl.widgetId;
...
const fieldConverterMap = {
    ...
    Link: function (field) {
        ...
        if (linkType === 'Asset') {
            ...
            const validations = (_a = field.validations) !== null && _a !== void 0 ? _a : [];
            const linkContentTypeValidation = lodash_1.default.find(validations, 'linkContentType');
            const linkContentTypes = (_b = linkContentTypeValidation === null || linkContentTypeValidation === void 0 ? void 0 : linkContentTypeValidation.linkContentType) !== null && _b !== void 0 ? _b : [];
            return {
                type: 'reference',
    ...
    RichText: function (field) {
        ...
        return {
            type: 'richText',
            options: {
                nodes: ((_a = nodeTypesValidation === null || nodeTypesValidation === void 0 ? void 0 : nodeTypesValidation.enabledNodeTypes) !== null && _a !== void 0 ? _a : []).map((node) => lodash_1.default.get(contentful_consts_1.CONTENTFUL_NODE_TYPES_MAP, node, 'unsupported')),
                marks: ((_b = marksValidation === null || marksValidation === void 0 ? void 0 : marksValidation.enabledMarks) !== null && _b !== void 0 ? _b : []).map((mark) => lodash_1.default.get(contentful_consts_1.CONTENTFUL_MARKS_TYPES_MAP, mark, 'unsupported'))
            }
        };
    }
};
...
function resolveLabelFieldForModel(contentType, modelLabelFieldPath, fields) {
    var _a;
    let labelField = (_a = contentType.displayField) !== null && _a !== void 0 ? _a : null;
    if (labelField) {
        return labelField;
    }
