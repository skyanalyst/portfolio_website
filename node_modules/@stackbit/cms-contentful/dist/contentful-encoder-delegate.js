...
class ContentfulEncoderDelegate {
                ...
                return {
                    fieldData: {
                        fields: {
                            title: {
                                type: 'string',
                                value: (_a = fieldValue[0]) === null || _a === void 0 ? void 0 : _a.public_id
                            },
                            url: {
                                type: 'string',
                                value: (_e = (_d = (_c = (_b = fieldValue[0]) === null || _b === void 0 ? void 0 : _b.derived) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.secure_url) !== null && _e !== void 0 ? _e : (_f = fieldValue[0]) === null || _f === void 0 ? void 0 : _f.secure_url
                            }
                        }
                    }
                };
    ...
    flattenRichText(node) {
        ...
        if (content) {
            return _.reduce(content, (accum, node) => {
...
//# sourceMappingURL=contentful-encoder-delegate.js.map