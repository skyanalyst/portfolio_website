...
async function readDirRecursively(dir, options) {
    ...
    const includeDirs = options === null || options === void 0 ? void 0 : options.includeDirs;
    const includeStats = options === null || options === void 0 ? void 0 : options.includeStats;
    const files = await fs_extra_1.default.readdir(dir);
    return (0, promise_utils_1.reducePromise)(files, async (result, file) => {
        const absFilePath = path_1.default.join(dir, file);
        const relFilePath = (options === null || options === void 0 ? void 0 : options.absoluteFilePaths) ? absFilePath : path_1.default.relative(rootDir, absFilePath);
        const stats = await fs_extra_1.default.stat(absFilePath);
        if ((options === null || options === void 0 ? void 0 : options.filter) && !options.filter(relFilePath, stats)) {
            return result;
        }
