...
async function createDocumentRecursively({ object, locale, modelName, contentSourceId, contentSourceDataById, assetSources, createDocument, userLogger }) {
    ...
    const modelFields = (_a = model.fields) !== null && _a !== void 0 ? _a : [];
    const csiModelFields = (_b = csiModel.fields) !== null && _b !== void 0 ? _b : [];
...
function sanitizeSlug(slug) {
    return slug === null || slug === void 0 ? void 0 : slug.split('/').map((part) => (0, slugify_1.default)(part, { lower: true })).join('/');
}
...
async function createUpdateOperationFieldRecursively({ value, modelField, csiModelField, fieldPath, locale, modelMap, csiModelMap, contentSourceId, contentSourceDataById, assetSources, createDocument, userLogger }) {
    ...
    if (csiModelField.type === 'object') {
        ...
        const result = await createObjectRecursively({
            ...
            csiModelFields: (_b = csiModel.fields) !== null && _b !== void 0 ? _b : [],
            fieldPath,
            locale,
            modelMap,
            csiModelMap,
        ...
        let refId;
        const assetSource = (0, asset_sources_utils_1.getAssetSourceBySourceName)(assetSources, csiModelField.source);
        if (assetSource) {
            ...
            return {
                field: {
                    type: 'image',
                    value: (0, asset_sources_utils_1.transformAssetSourceDataForAssetSource)(sourceData, assetSource)
                },
                newRefDocumentIds: []
            };
        }
        ...
        if (lodash_1.default.isPlainObject(value)) {
            refId = (_c = value.$$ref) !== null && _c !== void 0 ? _c : value.url;
        }
        else {
            refId = value;
        }
        ...
        if (modelField.source) {
            ...
            if (assetSource) {
                value = (0, asset_sources_utils_1.transformAssetSourceDataForAssetSource)(value, assetSource);
            }
        }
        return {
            field: {
...
async function convertOperationField({ operationField, fieldPath, modelField, csiModelField, locale, modelMap, csiModelMap, contentSourceId, contentSourceDataById, assetSources, createDocument, userLogger }) {
    ...
    switch (operationField.type) {
        ...
        case 'cross-reference': {
            ...
            return {
                type: csiModelField.type,
                value: (0, types_1.isOneOfFieldTypes)(csiModelField.type, ['json', 'cross-reference']) ? refObject : JSON.stringify(refObject)
            };
        }
        case 'list': {
