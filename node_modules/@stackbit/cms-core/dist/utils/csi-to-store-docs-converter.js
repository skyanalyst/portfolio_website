 ...
 */
function mapCSIDocumentsToStoreDocuments({ csiDocuments, contentSourceInstance, modelMap, defaultLocaleCode, assetSources, createConfigDelegate, customActionRunStateMap }) {
...
function mapCSIDocumentToStoreDocument({ csiDocument, model, modelMap, defaultLocaleCode, meta, assetSources, createConfigDelegate, customActionRunStateMap }) {
    var _a, _b;
    return (0, utils_1.omitByNil)({
        type: 'document',
        ...meta,
        ...
        getPreview: ({ delegate, locale }) => getDocumentPreview({
            ...
            delegate: delegate !== null && delegate !== void 0 ? delegate : createConfigDelegate(),
            locale
        }),
        ...
        getDocumentActions: (0, custom_actions_1.getDocumentActionsThunk)({
            csiDocument,
            model: model,
            srcType: meta.srcType,
            srcProjectId: meta.srcProjectId,
...
function mapCSIFieldsToStoreFields({ csiDocumentFields, modelFields, context }) {
    return modelFields.reduce((result, modelField) => {
        ...
        if (Array.isArray(modelField.actions)) {
            docField.getFieldActions = ({ locale } = {}) => (0, custom_actions_1.getFieldActions)({
                modelField,
...
function mapImageField(csiDocumentField, imageModelField, assetSources) {
    var _a;
    ...
    if (!(0, types_1.isLocalizedField)(csiDocumentField)) {
        return (0, utils_1.omitByNil)({
            ...
            fields: (_a = csiDocumentField.fields) !== null && _a !== void 0 ? _a : (0, asset_sources_utils_1.getImageFieldsFromSourceData)({
                sourceData: csiDocumentField.sourceData,
                imageModelField: imageModelField,
                assetSources
            })
    ...
    return (0, utils_1.omitByNil)({
        ...
        locales: lodash_1.default.mapValues(csiDocumentField.locales, (locale) => {
            ...
            return {
                ...
                (_a = locale.fields) !== null && _a !== void 0 ? _a : (0, asset_sources_utils_1.getImageFieldsFromSourceData)({
                    sourceData: locale.sourceData,
                    imageModelField: imageModelField,
                    assetSources
                })
...
function mapObjectField(csiDocumentField, modelField, context) {
    ...
    const _getObjectPreview = ({ delegate, locale }) => {
        return getObjectPreview({
            ...
            srcType: context.srcType,
            srcProjectId: context.srcProjectId,
            delegate: delegate !== null && delegate !== void 0 ? delegate : context.createConfigDelegate(),
            locale
        });
    };
    const _getObjectActions = (fieldPath) => (0, custom_actions_1.getObjectFieldActionsThunk)({
    ...
    if (!(0, types_1.isLocalizedField)(csiDocumentField)) {
        return {
            ...
            fields: mapCSIFieldsToStoreFields({
                csiDocumentFields: (_a = csiDocumentField.fields) !== null && _a !== void 0 ? _a : {},
                modelFields: (_b = modelField.fields) !== null && _b !== void 0 ? _b : [],
                context
            })
        };
    }
    return {
        ...
        locales: lodash_1.default.mapValues(csiDocumentField.locales, (locale) => {
            ...
            return {
                ...
                fields: mapCSIFieldsToStoreFields({
                    csiDocumentFields: (_a = locale.fields) !== null && _a !== void 0 ? _a : {},
                    modelFields: (_b = modelField.fields) !== null && _b !== void 0 ? _b : [],
                    context: {
                        ...context,
                        fieldPath: fieldPath
...
function mapModelField(csiDocumentField, modelField, context) {
    ...
    const _getObjectActions = (model, fieldPath) => (0, custom_actions_1.getObjectModelActionsThunk)({
        csiParentDocument: context.parentDocument,
        model: model,
        srcType: context.srcType,
        srcProjectId: context.srcProjectId,
    ...
    if (!(0, types_1.isLocalizedField)(csiDocumentField)) {
        ...
        return {
            ...
            srcModelLabel: (_a = model.label) !== null && _a !== void 0 ? _a : lodash_1.default.startCase(model.name),
            getObjectActions: _getObjectActions(model, context.fieldPath),
            fields: mapCSIFieldsToStoreFields({
                csiDocumentFields: (_b = csiDocumentField.fields) !== null && _b !== void 0 ? _b : {},
                modelFields: (_c = model.fields) !== null && _c !== void 0 ? _c : [],
                context
            })
        };
    }
...
function mapListField(csiDocumentField, modelField, context) {
    if (!(0, types_1.isLocalizedField)(csiDocumentField)) {
        return {
            type: csiDocumentField.type,
            items: csiDocumentField.items.map((item, index) => {
                var _a;
    ...
    return {
        ...
        locales: lodash_1.default.mapValues(csiDocumentField.locales, (locale) => {
            ...
            return {
                locale: locale.locale,
                items: ((_a = locale.items) !== null && _a !== void 0 ? _a : []).map((item, index) => {
                    var _a;
                    return mapCSIFieldToStoreField({
                        csiDocumentField: item,
                        modelField: (_a = modelField.items) !== null && _a !== void 0 ? _a : { type: 'string' },
...
function getObjectTitleFromLabelField({ document, documentField, modelOrObjectField, delegate, locale }) {
