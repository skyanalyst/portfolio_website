    ...
    switch (documentField.type) {
        ...
        case 'image': {
            ...
            if (localizedField && !localizedField.isUnset) {
                if (localizedField === null || localizedField === void 0 ? void 0 : localizedField.sourceData) {
                    return localizedField === null || localizedField === void 0 ? void 0 : localizedField.sourceData;
                }
                const localizedUrl = (0, content_store_utils_1.getDocumentFieldForLocale)(localizedField.fields.url, locale);
                return localizedUrl === null || localizedUrl === void 0 ? void 0 : localizedUrl.value;
            }
            break;
        }
        case 'object': {
        ...
        case 'list': {
            ...
            if (localizedField) {
                return ((_a = localizedField.items) !== null && _a !== void 0 ? _a : [])
...
function shouldDuplicate({ referenceField, modelName, seenReferences, referenceBehavior, nonDuplicatableModels, duplicatableModels }) {
    return (!seenReferences.includes(referenceField.refId) &&
        ...
        ((referenceBehavior === 'duplicateContents' && !(nonDuplicatableModels !== null && nonDuplicatableModels !== void 0 ? nonDuplicatableModels : []).includes(modelName)) ||
            (referenceBehavior === 'copyReference' && (duplicatableModels !== null && duplicatableModels !== void 0 ? duplicatableModels : []).includes(modelName))));
}
