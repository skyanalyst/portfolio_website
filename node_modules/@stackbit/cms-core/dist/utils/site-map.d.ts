...
export declare type SiteMapEntriesSourceKeys = string | symbol;
/**
 ...
 * }
 */
export declare type SiteMapEntryGroups = Record<SiteMapEntriesSourceKeys, Record<string, SiteMapEntry>>;
...
export declare function getSiteMapGroupKeyForDocument({ srcType, srcProjectId, srcDocumentId }: {
    srcType: string;
    srcProjectId: string;
